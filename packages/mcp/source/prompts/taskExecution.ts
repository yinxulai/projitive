  ...
  server.registerPrompt(
    ...
    async ({ projectPath, taskId }) => {
      ...
      const text = [
        ...
        '- Identify task acceptance criteria and write them explicitly in the task payload',
        ...
        '- When creating or updating tasks, include acceptanceCriteria and dependencies whenever they clarify delivery scope or sequencing.',
